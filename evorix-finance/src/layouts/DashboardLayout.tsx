...
import { LayoutDashboard, Briefcase, BarChart2, User, Settings, Bell, Headset, ChevronLeft, ChevronRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-evo-bgMain text-evo-textMain font-sans flex">
      ...
      >
        ...
        <nav className="flex-1 px-4 space-y-2 mt-2">
          ...
          <SidebarLink icon={<BarChart2 size={20} />} text="Análises" to="/analises" active={location.pathname === '/analises'} collapsed={collapsed} />
        ...
        <div className="p-4 border-t border-evo-border space-y-4">
          {/* Card de Assessoria (só aparece completo se não estiver colapsado) */}
          {collapsed ? (
            <Link
              to="/assessoria"
          ...
          <div className="space-y-2">
            <SidebarLink icon={<User size={20} />} text="Seu Perfil" to="/perfil" active={location.pathname === '/perfil'} collapsed={collapsed} />
            <SidebarLink icon={<Settings size={20} />} text="Configurações" to="/config" active={location.pathname === '/config'} collapsed={collapsed} />
          </div>
        </div>
      </aside>
